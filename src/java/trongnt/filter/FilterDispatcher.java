...
public class FilterDispatcher implements Filter {
    ...
    public FilterDispatcher() {
        ...
        USER.add("LoadAllBookController");
        ...
        ADMIN.add("AdminInsertController");
        ADMIN.add("AdminLoadAllBookController");
        ADMIN.add("AdminUpdateController");
